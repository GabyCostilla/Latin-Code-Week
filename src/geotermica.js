        ...
        <div className="geoter-container">
            ...
            <main className="geoter-content">
                ...
                <p>
                    ...
                    girar turbinas y generar electricidad. ⚙️⚡
                </p>
                <img
                    src={Geothermica_p}
                    alt="Energía Geotérmica"
                ...
                />
                <p>
                    En resumen, la energía geotérmica se utiliza para sistemas
                    de calefacción y refrigeración geotérmica en edificios.
                    Estos sistemas aprovechan la temperatura constante del suelo
                    para climatizar de manera eficiente. Además, tiene varios
